...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "tweets_replies" ADD CONSTRAINT "tweets_user_id_profiles_id_fk" FOREIGN KEY ("user_id") REFERENCES "profiles"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
