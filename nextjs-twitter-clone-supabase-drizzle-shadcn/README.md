# Twitter Clone using Superbase
[Link github](https://github.com/sonipranjal/ultimate-twitter-clone)


## Testing Drizzle Performance
Go to `src/components/compose-tweet.tsx`
line `#33`
